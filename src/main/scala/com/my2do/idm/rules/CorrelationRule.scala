...
/**
  *  Trait that correlates incoming ICF attributes against a user in the repo
  *
  * User: warren
  * Date: 4/20/11
  * Time: 4:06 PM
...
trait CorrelationRule {
  /**
    * @param a - incoming Identity Connector attributes
    * @return - An optional correlated user - or None if no correlation is found
    */
